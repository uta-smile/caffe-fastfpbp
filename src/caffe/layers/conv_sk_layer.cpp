...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::forward_cpu_gemm(const Dtype* input,
...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::forward_cpu_bias(Dtype* output,
    const Dtype* bias) {
...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::backward_cpu_gemm(const Dtype* output,
...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::weight_cpu_gemm(const Dtype* input,
...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::backward_cpu_bias(Dtype* bias,
    const Dtype* input) {
...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::forward_gpu_gemm(const Dtype* input,
    const Dtype* weights, Dtype* output, bool skip_im2col) {
  const Dtype* col_buff = input;
  if (!is_1x1_) {
    if (!skip_im2col) {
...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::forward_gpu_bias(Dtype* output,
    const Dtype* bias) {
...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::backward_gpu_gemm(const Dtype* output,
    const Dtype* weights, Dtype* input) {
...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::weight_gpu_gemm(const Dtype* input,
    const Dtype* output, Dtype* weights) {
  const Dtype* col_buff = input;
  if (!is_1x1_) {
    conv_im2col_gpu(input, col_buffer_.mutable_gpu_data());
...
template <typename Dtype>
void ConvolutionSKLayer<Dtype>::backward_gpu_bias(Dtype* bias,
    const Dtype* input) {
...
template<typename Dtype>
void ConvolutionSKLayer<Dtype>::compute_output_shape() {
	int ext_kernel_h = (this->kernel_h_ - 1) * this->kstride_h_ + 1;
	int ext_kernel_w = (this->kernel_w_ - 1) * this->kstride_w_ + 1;
	this->height_out_ = (this->height_ - ext_kernel_h) / this->stride_h_ + 1;
	this->width_out_ = (this->width_ - ext_kernel_w) / this->stride_w_ + 1;
}
